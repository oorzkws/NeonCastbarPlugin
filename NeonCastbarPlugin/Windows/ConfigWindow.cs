...
namespace NeonCastbarPlugin.Windows;
...
public class ConfigWindow : Window, IDisposable
{
    ...
    public override void Draw()
    {
        ...
        var affectsNameplateCastbar = configuration.AffectsNameplateCastbar;
        if (ImGui.Checkbox("Color Nameplate Castbar", ref affectsNameplateCastbar))
        {
            configuration.AffectsNameplateCastbar = affectsNameplateCastbar;
            configuration.Save();
        }
